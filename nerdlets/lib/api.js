...
export const fetchHosts = params => {
  ...
  return SaasProxy.VIVIDCORTEX.get(`/hosts?${toGetParams(params)}&nest=tags`)
...
export const fetchQueries = (params, hosts, metrics) => {
  ...
  return SaasProxy.VIVIDCORTEX.post(`metrics/query-series?${toGetParams(params)}`, payload)
...
export const fetchQuery = query => {
  return SaasProxy.VIVIDCORTEX.get(`queries/${query}`)
